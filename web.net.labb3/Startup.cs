...
using web.net.labb3.CustomHelpers;
using Microsoft.EntityFrameworkCore.Storage;

namespace web.net.labb3
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<webnetlabb3Context>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("webnetlabb3Context")
                    ));
        }
